...
const ServiceCard = ({ title, content, href }) => {
  return (
    <Link href={href}>
      <div className="card w-[20rem] mb-10 md:w-96 bg-[#f5f5f4] shadow-xl lg:mb-1 lg:min-h-[19rem] mr-5 transform transition-transform hover:scale-105 cursor-pointer">
